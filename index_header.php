...
<body>
  <header>
    <div class="logo">
        <a href="index.php"><span>Readify</span>
            <span class="me">Bookstore</span></a>
    </div>
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">Just Arrived</a>
    ...
    <?php if(isset($_SESSION['user_name'])){echo' <img style="height:40px; margin-left:10px ;" src="images/ds2.png" class="user-pic" onclick="toggleMenu()" />';}
        ...
        echo'<div class="use_links"><a class="link_Btn" style="background-color: black;
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
        font-weight: 500;" href="login.php">Login</a><a class="link_Btn" style="background-color: white;
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
