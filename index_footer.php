...
<footer style="margin: 30px auto 0;">
    <div class="main" style="align-items:center; padding:20px; ">
        
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Nina Angel Mukiiza  | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;"> Readify</span>
                    <span class="me" style="font-size: 15px;">Bookstore</span></a>
            </div> 
        </div>
    </div>
</footer>